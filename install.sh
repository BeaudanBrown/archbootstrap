...
# DEFAULTS:
[ -z "$dotfilesrepo" ] && dotfilesrepo="https://github.com/BeaudanBrown/dotarch.git" && repobranch="archi3"
...
finalize(){ \
	...
	echo "exec_always --no-startup-id notify-send -i ~/.local/share/larbs/larbs.png 'Welcome:' 'Press Super+F1 for the manual.' -t 10000"  >> "/home/$name/.config/i3/config"
